...
export function PrivacyPage() {
  ...
  return (
    <SimplePage eyebrow="Privacy" title="How we treat your data.">
      <p>Short version: your stories are yours. Your drafts are private until you publish them. We never sell your data, we never train AI models on your writing, and you can delete your account and every story you&apos;ve written at any time.</p>
